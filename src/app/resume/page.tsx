      ...
      <div className="container mx-auto">
        ...
        <Tabs defaultValue="experience"
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="Education" className="">Education</TabsContent>
            <TabsContent value="Skills" className="">Skills</TabsContent>
            <TabsContent value="About" className="">About</TabsContent>
          </div>
        </Tabs>
